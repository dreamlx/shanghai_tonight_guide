# RailsAdmin config file. Generated on October 14, 2012 19:43
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['NightLife guide', 'Admin']
  ...
  # config.excluded_models = [Area, Category, City, Girl, Place, Province, Role, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Area, Category, City, Girl, Place, Province, Role, User]
  ...
  #   update do; end
  # end
  # config.model Girl do
  #   # Found associations:
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :age, :integer 
  #     configure :livein, :string 
  #     configure :desc, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  ...
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :place_name, :string 
  #     configure :area_id, :integer 
  #     configure :address, :string 
  #     configure :category_id, :integer 
  #     configure :user_id, :integer 
  #     configure :desciption, :text 
  #     configure :glat, :string 
  #     configure :glng, :string 
  ...
  #     configure :private_token, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
