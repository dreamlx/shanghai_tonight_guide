  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "place_id" => "invalid value" }}, valid_session
        assigns(:order).should be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        Order.any_instance.should_receive(:update_attributes).with({ "place_id" => "" })
        put :update, {:id => order.to_param, :order => { "place_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Order.any_instance.stub(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "place_id" => "invalid value" }}, valid_session
        assigns(:order).should eq(order)
      end
